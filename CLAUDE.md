...
- **Payment**: LianLian Bank payment form (no external SDK)
...
│   ├── payment/     # LianLianCheckout, PaymentStatus
...
- **Booking flow**: Select room -> BookingForm -> POST /bookings -> POST /payments/initiate/:bookingId -> get transactionId -> LianLianCheckout confirm -> POST /payments/confirm/:transactionId -> redirect to BookingDetail
